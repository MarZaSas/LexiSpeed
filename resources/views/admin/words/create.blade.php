...
<div class="panel-card overflow-hidden" style="max-width: 760px; margin: 0 auto;">
    <div class="p-4 p-md-5" style="background: linear-gradient(90deg, rgba(56,189,248,0.18), rgba(34,197,94,0.18), rgba(168,85,247,0.18)); border-bottom: 1px solid rgba(255,255,255,0.08);">
        <h1 class="title-gradient mb-2">Nueva palabra</h1>
        <p class="mb-0 subtitle-text">Añade nuevas palabras al sistema y clasifícalas por dificultad.</p>
    </div>
        ...
        <form action="{{ route('words.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="mt-2" style="color:#94a3b8;">
                    Introduce una palabra única que se utilizará dentro del juego.
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="difficulty" id="difficulty" class="form-select difficulty-select" required>
                    ...
                    <option value="medium" {{ old('difficulty') == 'medium' ? 'selected' : '' }}>Intermedio</option>
            ...
            <div class="d-flex flex-wrap gap-2">
                <button type="submit" class="btn btn-success btn-game">Guardar palabra</button>
